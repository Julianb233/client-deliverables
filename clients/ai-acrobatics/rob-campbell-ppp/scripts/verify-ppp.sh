...
REQUIRED_PAGES=("app/page.tsx" "app/progress/page.tsx" "app/game-plans/page.tsx" "app/deliverables/page.tsx" "app/changelog/page.tsx" "app/action-items/page.tsx" "app/activity/page.tsx" "app/more/page.tsx")
...
REQUIRED_DATA=("data/client-data.ts" "data/changelog.ts" "data/deliverables.ts" "data/action-items.ts" "data/milestones.ts" "data/meeting-notes.ts")
