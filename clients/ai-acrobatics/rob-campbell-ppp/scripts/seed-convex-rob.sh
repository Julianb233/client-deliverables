...
npx convex run portalFeed:insertFromHttp '{"clientSlug":"rob-campbell","type":"action-needed","title":"June 10 working call and retainer decision","body":"Rob should pick a June 10 working-call time and choose the starting monthly retainer tier: Operator, Growth, or Build Partner.","url":"https://rob-campbell-ppp.vercel.app/action-items","icon":"calendar","agent":"Codex"}'
...
npx convex run portalChangelog:insertFromHttp '{"clientSlug":"rob-campbell","title":"June 10 call and retainer action plan published","description":"PPP action items now ask Rob to schedule the June 10 working call and choose the starting retainer package.","category":"operations","items":["June 10 working call ask","Operator/Growth/Build Partner retainer choice","Convex backend partial status clarified","Hermes agent-profile routing configured"],"linearIssueIds":["AI-10321","AI-10564"],"repo":"rob-campbell-ppp","agent":"Codex"}'
...
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-007","title":"Book June 10 working call","why":"Rob just had his baby and the next working session should lock access, retainer choice, and first-sprint priorities.","howTo":"Choose a June 10 time that works with the new-baby schedule; use the 1-hour onboarding call when possible; bring HubSpot access status, retainer preference, and first-priority workflow questions.","impact":"Unblocks the implementation working session and first sprint.","estimatedTime":"5 minutes","priority":"high","status":"open","linearUrl":"https://rob-campbell-ppp.vercel.app/book-onboarding"}'
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-008","title":"Choose starting retainer package","why":"The agents need the monthly operating tier to set reporting cadence, review rhythm, dev/consulting capacity, and AI credit planning.","howTo":"Pick Operator at $1,500/mo, Growth at $2,500/mo, or Build Partner at $4,500/mo; confirm with Julian before recurring billing starts.","impact":"Sets the first active operating month and the support level for Rob's AI Prospect Engine.","estimatedTime":"10 minutes","priority":"high","status":"open","linearUrl":"https://rob-campbell-ppp.vercel.app/billing"}'
