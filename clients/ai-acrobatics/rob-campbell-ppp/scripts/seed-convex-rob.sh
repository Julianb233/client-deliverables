...
npx convex run portalFeed:insertFromHttp '{"clientSlug":"rob-campbell","type":"milestone","title":"Growth Retainer confirmed","body":"Rob's signed monthly agreement is the $2,500 Growth Retainer with 7 development or consulting hours and expanded AI usage. Retainer selection is complete; invoice standing is tracked separately.","url":"https://rob-campbell-ppp.vercel.app/billing","icon":"payment","agent":"Codex"}'
...
npx convex run portalChangelog:insertFromHttp '{"clientSlug":"rob-campbell","title":"Growth Retainer recorded as active","description":"PPP billing and operating records now show Rob's signed $2,500 monthly Growth Retainer instead of asking him to select a tier.","category":"operations","items":["Growth Retainer marked active","7 development or consulting hours recorded","Expanded AI usage recorded","Operator tier hidden","Invoice standing kept separate"],"linearIssueIds":["AI-10321"],"repo":"rob-campbell-ppp","agent":"Codex"}'
...
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-004","title":"Growth Retainer confirmed","why":"Rob and Julian agreed to the $2,500 monthly Growth Retainer.","howTo":"No tier selection is needed. Track included hours, expanded AI usage, delivered value, and invoice standing as separate operating records.","impact":"Sets the active reporting, monitoring, and development capacity for month one.","estimatedTime":"Complete","priority":"medium","status":"resolved","linearUrl":"https://rob-campbell-ppp.vercel.app/billing"}'
...
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-007","title":"Book implementation working call","why":"The next working session should lock access and first-sprint priorities for the active Growth Retainer cadence.","howTo":"Choose a time that works; use the 1-hour onboarding call when possible; bring HubSpot access status and first-priority workflow questions.","impact":"Unblocks the implementation working session and first sprint.","estimatedTime":"5 minutes","priority":"high","status":"open","linearUrl":"https://rob-campbell-ppp.vercel.app/book-onboarding"}'
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-008","title":"Start the Growth Retainer operating cadence","why":"The active $2,500 monthly plan sets the reporting rhythm, 7 included development or consulting hours, and expanded AI usage.","howTo":"Run the agreed cadence; report hours, usage, delivered value, blockers, and next recommendations each month.","impact":"Activates the ongoing operating support for Rob's AI Prospect Engine.","estimatedTime":"Ongoing","priority":"high","status":"resolved","linearUrl":"https://rob-campbell-ppp.vercel.app/billing"}'
...
npx convex run portalUpsellOffers:upsertByClientOffer '{"clientSlug":"rob-campbell","offerSlug":"operator-retainer","title":"Operator Retainer","category":"retainer","outcome":"Monthly monitoring, light workflow tuning, reports, and AI credit coverage.","whyItFits":"Superseded by Rob's signed Growth Retainer.","setupEstimate":"Not available for Rob","priceLabel":"$1,500/mo - not Rob's active plan","requestOnly":true,"status":"hidden","sortOrder":50}'
npx convex run portalUpsellOffers:upsertByClientOffer '{"clientSlug":"rob-campbell","offerSlug":"growth-retainer","title":"Growth Retainer","category":"retainer","outcome":"Weekly signal reviews, deeper iteration, 7 development or consulting hours, expanded AI usage, and monthly reporting.","whyItFits":"This is Rob's signed monthly operating agreement for the AI Prospect Engine.","setupEstimate":"Signed and active","priceLabel":"$2,500/mo","requestOnly":true,"status":"active","sortOrder":60}'
