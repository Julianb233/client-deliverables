...
npx convex run portalClients:upsertBySlug "$(cat <<'JSON'
{
  ...
  "fanbasis_payment_url": "https://www.fanbasis.com/agency-checkout/Aiacrobatics/MNYXB",
  ...
  "health_score": 88,
  "onboarding_status": "growth-retainer-active",
  "onboarded": true,
  "metadata": {
    "sourceIssue": "AI-8865",
    "projectIssue": "AI-10321",
    "pppIssue": "AI-10329",
    "paymentStatus": "Growth retainer active",
    "depositAmount": 5500,
    "depositReceived": true,
    "totalPaid": 10500,
    "paidTransactionCount": 3,
    "activeRetainer": "Growth",
    "activeRetainerAmount": 2500,
    "activeRetainerStartedAt": "2026-06-17",
    "activeThrough": "2026-08-16",
    "setupBalanceStatus": "unconfirmed",
...
npx convex run portalFeed:insertFromHttp '{"clientSlug":"rob-campbell","type":"action-needed","title":"Agent roster and setup-balance review","body":"Rob should review the focused Hermes agent roster and confirm whether the separate setup balance was paid through Apple Cash or Commas. The Growth Retainer is already active.","url":"https://rob-campbell-ppp.vercel.app/action-items","icon":"review","agent":"Codex"}'
...
npx convex run portalChangelog:insertFromHttp '{"clientSlug":"rob-campbell","title":"Payment history and active retainer reconciled","description":"PPP billing now reflects three verified Commas payments totaling $10,500 and the active Growth Retainer without counting the unconfirmed setup balance as paid.","category":"operations","items":["$5,500 deposit verified","Two $2,500 Growth Retainer payments verified","Growth Retainer marked active","Setup balance kept separate until confirmed"],"linearIssueIds":["AI-10321"],"repo":"rob-campbell-ppp","agent":"Codex"}'
...
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-004","title":"Reconcile remaining setup balance","why":"The Growth Retainer is active, but the separate setup balance is not yet confirmed as paid.","howTo":"Confirm whether the setup balance was paid through Apple Cash or Commas; do not use both payment methods; send confirmation to Julian.","impact":"Keeps the payment history accurate and prevents duplicate payment.","estimatedTime":"5 minutes","priority":"medium","status":"open","linearUrl":"https://rob-campbell-ppp.vercel.app/billing"}'
...
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-007","title":"Review the client workspace and agent roster","why":"Rob needs to confirm that the focused eight-agent Hermes roster matches how he and his team will work.","howTo":"Open the Client Workspace page; review the agent roles and priorities; send edits through the Request Center.","impact":"Locks the role definitions and routing for the next operating cycle.","estimatedTime":"15 minutes","priority":"high","status":"open","linearUrl":"https://rob-campbell-ppp.vercel.app/workspace"}'
npx convex run portalActionItems:upsertByLinearId '{"clientSlug":"rob-campbell","linearIssueId":"rob-action-008","title":"Growth retainer activated","why":"The $2,500/month Growth Retainer started June 17 and renewed July 17.","howTo":"No additional retainer checkout is needed; contact Julian before changing or cancelling the plan.","impact":"Sets the active operating cadence without creating a duplicate subscription.","estimatedTime":"0 minutes","priority":"high","status":"resolved","linearUrl":"https://rob-campbell-ppp.vercel.app/billing"}'
...
npx convex run portalUpsellOffers:upsertByClientOffer '{"clientSlug":"rob-campbell","offerSlug":"growth-retainer","title":"Growth Retainer","category":"retainer","outcome":"Adds weekly signal reviews, deeper iteration, and more dev/consulting capacity.","whyItFits":"This is Rob's active operating plan.","setupEstimate":"Active since June 17, 2026","priceLabel":"$2,500/mo","checkoutUrl":"https://www.fanbasis.com/agency-checkout/Aiacrobatics/rgV2w","status":"active","sortOrder":60}'
npx convex run portalUpsellOffers:upsertByClientOffer '{"clientSlug":"rob-campbell","offerSlug":"build-partner-retainer","title":"Build Partner Retainer","category":"retainer","outcome":"Priority build capacity for deeper experiments, strategy, and workflow iteration.","whyItFits":"Use this when Rob wants the AI Prospect Engine treated as a core operating system instead of light monthly support.","setupEstimate":"Starts after initial build","priceLabel":"$4,500/mo","checkoutUrl":"https://www.fanbasis.com/agency-checkout/Aiacrobatics/qALQ3","status":"available","sortOrder":70}'
